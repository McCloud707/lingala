...
export default function Home() {
  ...
  const [email, setEmail] = useState<string>('Enter your E-Mail address to join the waitlist!')
  ...
  return (
    <div className="min-h-screen flex items-center justify-center text-center">
      ...
      <h2 className="text-4 sm:text-lg md:text-xl mb-16 font-medium">A comprehensive language learning application that learns about you</h2>
      ...
      {
        success ? <p className="text-lg">You&apos;ve been added to the Waitlist. See you soon</p> :
        <>
        <Input 
        value={email}
        className={"placeholder:text-black  focus:placeholder-transparent w-6/8 text-center py-4 md:placeholder:text-lg placeholder:text-xs" + (message !== "" ? " placeholder:text-red-500" : "")}
